...
?>
					...
					<!-- <form name='myForm' action='ecSubmit.php' method='post' onSubmit='return false'>-->
						...
						if (isset($_POST['submit_EC'])) {		
							...
							if ($submit_result[0] == "success") {
								...
								$to = "julie.mcnally@ericsson.com; julian.fitzsimons@ericsson.com; brian.moran@ericsson.com; kezzia.porter@ericsson.com; lizhou.wang@ericsson.com; dominic.holmes@ericsson.com; vivienne.manning@ericsson.com;";
						...
						<table id='EC_submit_form'>
							...
							$sql_shipments_result = "SELECT DISTINCT shipment from nmi_baseline.document_details WHERE  `shipment` LIKE  '%ENIQ_E13%' ORDER BY shipment DESC;";
	...
	<script type='text/javascript' src='js/ECSubmit1.js'></script>
