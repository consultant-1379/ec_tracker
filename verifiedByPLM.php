...
if (isset($_POST['verifiedByST'])) {	
	...
	//$to = "julie.mcnally@ericsson.com; brian.moran@ericsson.com; julian.fitzsimons@ericsson.com; kezzia.porter@ericsson.com; dominic.holmes@ericsson.com; vivienne.manning@ericsson.com; lizhou.wang@ericsson.com;";
	$to = "PDLASSUREC@ex1.eemea.ericsson.se; peter.doran@ericsson.com; martina.brady@ericsson.com; alan.donnelly@ericsson.com";
	$subject = "An EC has been verified by PLM";
	$message = "An EC " . $sql_ec_id . " has been verified by PLM </br> Please see <a href='http://eniqdmt.lmera.ericsson.se/ectracker/'>EC Tracker</a> for details";
	...
	<span style='color:green; display:block; padding-top:15px;'>
		Done! 
		</br>A notification mail has been sent to PLM.
	</span>";
...
if (isset($_REQUEST['ecId'])) {
	...
	if($result_comment_info){
	 ...
	 echo "<form name='myForm' action='verifiedByPLM.php' method='post'>";
