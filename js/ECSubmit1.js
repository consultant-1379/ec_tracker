...
function validateECForm() {
	...
	if	($.trim(document.getElementById('package1_gasklink').value) == ""){
		document.getElementById('package1gasklink_error').innerHTML = "The link must be GASK!";
		flag = 1;
	} else if(($.trim(document.getElementById('package1_gasklink').value).indexOf("gask2web")) == -1){
		document.getElementById('package1gasklink_error').innerHTML = "The link must be GASK!";
	}else {
		document.getElementById('package1gasklink_error').innerHTML = "";
	}
